...
const projects: Project[] = [
  // ...existing projects...
  {
    ...
    shortDescription: "A short description of your project goes here.",
    description: [
      "This is a placeholder for your project description. Replace this text with details about your project, its goals, and outcomes."
    ],
    features: [
      "Feature 1",
      "Feature 2",
    ...
    gallery: [
      { url: "/placeholder.jpg", caption: "Project Screenshot" }
    ],
    timeline: "Duration (e.g., 2 months, 2025)",
  ...
  },
  {
    ...
    role: "Your Role (e.g., Mobile Developer)",
    liveUrl: "https://your-live-url.com",
    githubUrl: "https://github.com/your-repo",
    relatedProjects: [],
  },
  {
    ...
    timeline: "Duration (e.g., 1 month, 2025)",
